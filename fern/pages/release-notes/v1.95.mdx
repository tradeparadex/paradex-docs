...
<Callout intent="info">
  **May 13th–May 16th, 2025** — Perpetual Options Fee Structure updates:, and more.
</Callout>
...
<Tabs>
  ...
  <Tab title="🟡 Testnet">
      <Accordion title="v1.95.8 — May 16th" defaultOpen={false}>
      ...
      * Taker - 0.03% (previously 0.06%) capped at 50% of Premium
      ...
      <Accordion title="v1.95.6-rc.1 — May 15th" defaultOpen={false}>
      ...
      * Realize `Funding PNL` proportionally to size reduction.
      ...
      <Accordion title="v1.95.3-rc.1 — May 14th" defaultOpen={false}>
      ...
      * Mobile Trade Page: Enhanced design for bottom tabs.
      ...
      <Accordion title="v1.95.1 — May 13th" defaultOpen={false}>
      ...
      * Taker - `0.06%` capped at `50%` of Premium (previously `300%`)
      ...
      <Accordion title="v1.95.0-rc.1 — May 10th" defaultOpen={false}>
