...
**Max slippage** defines the largest acceptable price deviation from the mark price. During execution, an order will be canceled if the price exceeds the slippage limit or falls outside the Market Price Band.
...
4. Adjust the slippage tolerance to your preferred percentage (e.g., 0.01 - 2)
