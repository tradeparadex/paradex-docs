...
Affiliates that are uniquely positioned to help grow Paradex's user base and mindshare can apply to join our new program via the [TAP Application Form](https://forms.gle/A6raA1inXn7GkqFh7). TAP is a separate rewards program with a dedicated pool of **1.0% of the fully diluted token supply**. This rewards pool is in addition to the standard XP program and TAP Affiliates earn from both programs simultaneously.

Potential Affiliates should [apply to TAP](https://forms.gle/A6raA1inXn7GkqFh7) if they meet the following criteria:
