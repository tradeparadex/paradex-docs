...
As of June 15 Paradex Retail go back to 0% for Takers and Makers on all markets. Pro fees for Perps and Spot stay intact, while Options fees are following newly updated structure (see below).
</Note>
