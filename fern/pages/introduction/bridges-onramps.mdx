...
| Chain | Paradex Bridge | Hyperlane | Layerswap | Orbiter Finance |
|:------|:---------------|:----------|:----------|:----------------|
| Arbitrum | - | ✅ | ✅ | ✅ |
| Avalanche | - | ✅ | ✅ | ✅ |
| Base | - | ✅ | ✅ | ✅ |
...
For detailed audit information and security reports, visit our [Security, Audits & Pentests documentation](/chain/security/audit-pentests).
</Note>
...
<AccordionGroup>
  <Accordion title="Paradex Bridge">
    ...
    **Supported Chains:**
    ...
    The Paradex Bridge contracts have undergone comprehensive security audits to ensure the safety of user funds. For detailed audit reports and security information, visit our [Security, Audits & Pentests documentation](/chain/security/audit-pentests).
    </Note>
  ...
  <Accordion title="Layerswap">
    ...
    **Learn More:**
    - [Layerswap Documentation](https://docs.layerswap.io/)
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Partner Documentation" icon="book">
    ...
    - [Layerswap Docs](https://docs.layerswap.io/)
