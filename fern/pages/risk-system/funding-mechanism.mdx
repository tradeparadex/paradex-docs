...
The **Funding Multiplier** is a per-market parameter between 0 and 1 that scales the funding rate before the max funding rate cap is applied. Most markets use a multiplier of 1 (no scaling). TradFi markets use a Funding Multiplier of 0.5.
