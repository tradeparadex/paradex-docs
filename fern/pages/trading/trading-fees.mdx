...
| ---------- | --------- | --------- | -------- |
| Standard Orders | **Free** (0%) | 2.0 bp (0.02%) | Simple fee structure for API traders |
| RPI Orders | 0.5 bp (0.005%) | N/A | Special liquidity provision for retail traders |

**RPI orders** are a special order type that provides liquidity specifically to retail traders. They must be placed inside the spread and can only match with GUI orders.
