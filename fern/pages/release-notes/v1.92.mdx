...
<Callout intent="info">
  **🟢 Prod: April 21st–April 25th, 2025** — Limit Position Close:, and more.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.92.7-rc.1): April 25th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.92.5-rc.1): April 24th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.92.4-rc.1): April 23rd** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.92.1-rc.1): April 21st** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.92.0-rc.1): April 18th** — Same changes.
</Callout>

</Accordion>

<Callout intent="note">
  **🟡 Testnet (v1.92.2-rc.1): April 22nd** — Testnet-only changes:
  * Mobile: Portfolio Page & Trade Page: Added `Total PnL`, `Total Funding` to Positions/Derivatives tabs. These replace the `Realized PnL` and `Unrealized PnL` columns.
  * Added `Rho` values to the `Risk tab` in Portfolio and Trade pages.
  * Bug fix - `Order Slider` fixed to work with leverage settings for `Isolated Margin Mode`.
  * Removed `Leverage` tag for Perpetual Options `open` positions.
