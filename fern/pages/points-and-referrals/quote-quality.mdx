...
1. **Sample Collection:** Quote Quality scores recorded every ~1 minute throughout the week
...
| Sample Quote Quality | A snapshot measurement taken every 10 seconds that evaluates current order quality |
...
<Steps>
  ...
  <Step title="Apply Distance Penalty">
    ...
    | Max Spread
    (Distance from Reference) | 5 bps | 15 bps | 15 bps |
