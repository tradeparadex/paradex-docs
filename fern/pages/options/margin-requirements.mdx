...
Paradex supports **Cross Margin** and **[Portfolio Margin](/risk/portfolio-margin)** for Perpetual Options. Cross Margin allows traders to benefit from PnL offsetting across futures and options markets. Portfolio Margin evaluates risk at the portfolio level for reduced margin requirements on hedged portfolios.

<Note>Portfolio Margin is currently in beta and available to whitelisted users.</Note>
