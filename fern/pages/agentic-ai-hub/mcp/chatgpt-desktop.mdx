...
ChatGPT Desktop supports MCP via both local and remote connections. The local setup is recommended because it supports trading — remote setups currently provide market data only.

## Local Setup (Recommended)

<Note>
Complete the [Prerequisites & Setup](/agentic-ai-hub/mcp/prerequisites) before proceeding. Local setup **supports trading**.
</Note>
