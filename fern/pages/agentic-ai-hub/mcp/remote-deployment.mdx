...
<Steps>
  ...
  <Step title="Connect your AI client">
    Paste that URL into your AI client's MCP settings.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Connect">
    Enter your endpoint URL (e.g. `https://your-domain.example.com/mcp`) and click **I trust this provider**.
  </Step>
</Steps>
