...
We have extended key generation to Starknet accounts, enabling your connected Starknet wallet to [deterministically derive a Paradex Account](/docs/trading/accounts/wallet-integration). Deposits and withdrawals on Starknet Wallets would be done via our [Cross Chain Bridging](deposits-and-withdrawals/cross-chain-bridging).
