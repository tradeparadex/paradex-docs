...
<img src="../../assets/risk/mark_price_data_inputs.png" alt=""/>
</Frame>
...
<img src="../../assets/risk/mark_price_implied_rates.png" alt=""/>
</Frame>
...
<img src="../../assets/risk/mark_price_ewma_rates.png" alt=""/>
</Frame>

### 4. Calculate the EWMA **(Exponentially Weighted Moving Average) of the Mid Rate**
...
### 5. Calculate the median of the External Rates
...
$$
\text{External Rate} = \Big(\frac{\text{Mark Price}}{\text{Index Price}} - 1\Big)
* \frac{\text{Paradex Funding Interval}}{\text{Exchange Funding Interval}}
$$

Where Paradex Funding Interval is actually 8h for all instruments

### 6. Calculate the Fair Basis

Finally, the **Fair Basis** is calculated as the median of the three components

$$
\begin{align*}
\text{Fair Basis} = \text{median}\big(
& \text{Paradex EWMA rates}, \\
& \text{Mid Rate EWMA}, \\
& \text{median(External Rates)}\big)
\end{align*}
$$

### 7. Calculate the Mark Price by applying the Fair Basis to the Spot Price
