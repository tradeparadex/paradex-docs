...
Complete these steps before connecting your AI client. If you only need market data (no trading), you can skip the private key step and go straight to [Connect your client](/agentic-ai-hub/mcp/connect-your-client).
...
Head to [Connect your client](/agentic-ai-hub/mcp/connect-your-client) and follow the instructions for your AI client.
