...
<Note title="Bridge Compatibility">
The table below shows deposit and withdrawal support across all bridge providers. ✅ indicates full support, - indicates not available.
</Note>
