...
Automatic Listing is triggered for strikes with Call Delta between 0.10 and 0.90. Each moneyness range follows specific strike step sizes depending on the underlying asset:

| **Moneyness** | **BTC** | **ETH** | **SOL** | **HYPE** |
| ------------- | ------- | ------- | ------- | -------- |
| **ATM**       | $500    | $50     | $5      | $1       |
| **Outer**     | $1,000  | $100    | $10     | $2       |
| **Wings**     | $2,000  | $200    | $20     | $5       |
