...
<Callout intent="info">
  **🟢 Prod: Oct 7th–Oct 9th, 2024** — Support Shizopunk NFT as profile picture, and more.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.63.0-rc.1): Oct 3rd** — Same changes.
</Callout>

</Accordion>

<Callout intent="note">
  **🟡 Testnet (v1.63.5-rc.1): Oct 11th** — Testnet-only changes:
...
<Callout intent="note">
  **🟡 Testnet (v1.63.3-rc.1): Oct 10th** — Testnet-only changes:
...
<Callout intent="note">
  **🟡 Testnet (v1.63.1-rc.1): Oct 8th** — Testnet-only changes:
  * Support Shizopunk NFT as profile picture.
  * Vaults:
  * Withdrawals & Deposits now feel much faster. You are free to use the app while the withdrawal/deposit is being processed.
  * Lifetime PnL charts for protocol/user vaults for table row and mobile cards list.
