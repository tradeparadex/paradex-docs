...
```mermaid
erDiagram
    "Best bid/ask prices" ||--o{ "Mark IV Calculator" : "Internal"
    "Last trade price" ||--o{ "Mark IV Calculator" : "Internal"
    "Mid price" ||--o{ "Mark IV Calculator" : "Internal"
    "External IV (Deribit)" ||--o{ "Mark IV Calculator" : "External"
    "Mark IV Calculator" ||--|| "Mark IV" : produces
