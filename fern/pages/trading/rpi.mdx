...
Suitable for retail traders looking for an enhanced trading experience.
...
Activated if order is submitted with retail JWT token. 
...
<Note>
  Both Retail and Standard profile order management are subject to [Rate limits](/api/general-information/rate-limits/api)
</Note>
