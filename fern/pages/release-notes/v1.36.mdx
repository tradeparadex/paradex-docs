...
<Callout intent="info">
  **v1.36 — April 2024**
  ...
  Points Programs rename: Liquidity Provider –> Maker Program, Trader –> Fee, and more.
</Callout>

<Accordion title="v1.36.2 — Points Programs rename: Liquidity Provider –> Maker Program, Trader" defaultOpen={true}>

  <Badge color="green">PROD  Apr 17th</Badge> <Badge color="yellow">TESTNET  Apr 17th</Badge>
