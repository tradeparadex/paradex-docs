...
<Warning>
Remote deployments do **not support trading** at the moment. Use a [local setup](/agentic-ai-hub/mcp/quickstart) for full API access including trading.
</Warning>
...
If you've cloned the repository locally, you can store these in a `.env` file:
