...
<Tabs>
  ...
  <Tab title="2026 & Beyond">
    ### Upcoming
    <CardGroup cols={4}>
      <Card title="Liquidity" icon="layer-group">
        - RFQ Trading w/ [Paradigm](https://app.paradigm.trade/))
        - Midpoint Dark Orders for Whales
        - TP/SL Triggers After Partial Fills
        - Dynamic TP/SL Updates with Parent Order Changes
        - TWAP Schedule Continuation on Sub-Order Failures
        - Reverse Positions
        - Estimated Slippage Display
        - Excess Slippage Warning
      </Card>
      <Card title="Products" icon="cubes-stacked">
        - Spot VTFs
        - Portfolio Margin
        - Dated Options
      ...
      <Card title="UX" icon="wand-magic-sparkles">
        - Fast Isolated Margin Transfers
        - Fast Isolated Margin Account Value Updates
        - Vaults Page Redesign
        - Customizable Position Tables
        - On-Chart Trading Tools
        - Funding History Table
        - TP/SL Modal 2.0
        - Notifications and Toasts 2.0
        - Liquidation Price Validation on SL Orders
      </Card>
      <Card title="Infra & Privacy" icon="lighthouse">
        - Reduce P95 order creation end to end latency < 50ms
        - Paradex Chain Mainnet
    ...
    <CardGroup cols={3}>
      <Card title="April 2026">
        **Liquidity & Trading**
          - DIME discount applied to all order types
          - Order Size Slider for Portfolio Margin accounts


        **Performance & Infra**
          - `/system/portfolio-margin-config` endpoint
          - Base-asset WS subscriptions for options BBO and Trades
          - Subaccount and vault key management
          - Filter options `/trades` by `base_asset`


        **UX**
          - New default `Dusk` theme at 110% UI scale
          - Smart Notifications with cross-tab sync and configurable location
          - Options chain: Calls/Puts, Around ATM, and Strike Range filters, sortable strikes, Recent Trades panel
          - Vaults rebranded as Vault Traded Funds (VTFs)
          - Live $DIME staked stats and buybacks summary card
          - Settings modal fixed size with scrollable content
      </Card>
    </CardGroup>

    ### 2026 Q1
    <CardGroup cols={3}>
      <Card title="January 2026">
        **New Markets**
          - 5 new perpetual markets


        **Performance & Infra**
          - Hyperlane external deposit link
          - External fair price in market summary API


        **UX**
          - Improved TPSL on-chart drag editing
          - Enhanced TP/SL precision with decimal inputs
          - Persistent TradingView crosshair color
          - Improved Order Builder styling
          - Transfer, Withdraw and Deposit buttons in Order Builder
          - Value column in Open Orders table
      </Card>
      <Card title="February 2026">
        **New Markets**
          - ETH Spot Market
          - [MoneyBadgers NFT](https://opensea.io/collection/moneybadgers) Launch


        **Performance & Infra**
          - Deposits via Smart Deposit Addresses
          - Fast position Unrealised PnL updates


        **UX**
          - On-chart limit and market order placement
          - Revamped Connected Wallet Deposit Flow
          - PnL display for Spot Asset balances
          - MoneyBadgers themed Position Share Cards
          - QR Code authentication on mobile
          - Scrollable filter bar on mobile
      </Card>
      <Card title="March 2026">
        **Performance & Infra**
          - `jwks` endpoint for JWT key validation
          - LIMIT TP/SL cancellation only on full fill
          - Theta in Market Summary API (private alpha)


        **UX**
          - New theme system: Terminal, Classic, Dusk, and "Fiddy" themes
          - UI scaling and flexible font sizing (80–120%)
          - TWAP Order Builder frequency selection and active orders filter
          - Mobile TP/SL modal redesign
          - Account switcher redesign on Portfolio page
          - XP page and profile stats card revamp
      </Card>
    </CardGroup>

  </Tab>

  <Tab title="2025 Achievements">
    <Frame caption="Paradex 2025 Journey">
      <img src="../../assets/Paradex_2025_Roadmap.jpeg" />
    </Frame>
    ...
    <CardGroup cols={3}>
      ...
      <Card title="Nov 2025">
        **New Markets**
          ...
          - [BadgerBoxes NFT](https://opensea.io/collection/badgerboxes)

        **Liquidity & Trading**
          - 50% of S2 XP, 100% of Preseason and S1 XP now transferrable
          - TPSL race condition fixes
          - Execute fixed size TPSL regardless of position size
          - BBO for max slippage estimation calculation
          - Switch to VWAP calculation for max slippage price
          - Size aggressive limit orders to price band

        **Performance & Infra**
          - Upgrade to SN 0.14 (Decentralized Sequencer Architecture)
          - High frequency mark price
          - Enhanced margin requirement calculations
          - Faster ticks for stop orders

        **UX**
          - Trading experience redesign (Desktop 3.0 / Mobile 2.0)
          - Draggable TPSL modals
          - Sound effect when position filled
          - Show funding and realized PnL on liquidations
          - Historical open interest data in market summary
          - Inventory page
          - Public XP transfers page
          - Anonymous XP Transfers
          - Referral page redesign
          - TAP affiliate program page
      </Card>
      <Card title="Dec 2025 (To Date)">
        **New Markets**
          - 2 new perpetual markets

        **Liquidity & Trading**
          - [Privacy Perps](/trading/privacy)
          - 75% of S2 XP now transferrable
          - Average fill price for max slippage calculation for market orders

        **Performance & Infra**
          - 4x faster orderbook animation

        **UX**
          - Portfolio Page Redesign
          - Autoscale charts when changing markets / time range
          - Customizable order book and order builder width
          - Configurable orderbook update refresh rate
          - Clear market menu search input after market selection
          - Specify time range in CSV exports
          - Support for `Keplr` and `Xverse` Starknet wallets
          - Block Explorer Page
      </Card>
    </CardGroup>
