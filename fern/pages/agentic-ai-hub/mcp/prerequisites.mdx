...
Complete these steps before connecting your AI client. If you only need market data (no trading), you can skip the private key step and go straight to your client's setup page from the [Quickstart guide](/agentic-ai-hub/mcp/quickstart).
