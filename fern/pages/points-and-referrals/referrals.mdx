...
## Overview
Get rewarded for bringing new traders to Paradex! Our new Season 2 referral programs offers benefits for both you and your referred users.
...
### Visit the Referral section in the app
    Click [here](https://app.paradex.trade/referrals) to jump there now!
