...
Vaults are smart contract-based asset pools in the DeFi ecosystem where investors use collateral assets (currently, only USDC is supported ) to buy Vault Tokens representing their share.

These pooled assets are managed by Vault Operators who employ trading strategies—currently focusing on perpetual futures only—to generate returns for token holders.



## Who should use Vaults?

* An Investor looking for higher yields or returns? -> Become a Vault Token Holder
* An Asset Manager looking for more capital base? -> Become a Vault Operator [Vault](https://app.paradex.trade/vaults)

Discover how vaults are designed to help you achieve financial freedom.



## Benefits for Investors (Vault Token Holders)
...
1. **Access to Larger Capital Pools**\
   Manage significant pooled assets from multiple investors, enabling you to execute larger trades and enhance profit potential.
...
5. **Reputation Building**\
   Successfully managing a vault and delivering consistent returns builds credibility, attracting more investors and opening doors within the DeFi ecosystem.
