...
<Callout intent="info">
  **Oct 24th–Oct 30th, 2024** — Underlying Price is now replaced with Spot Price in markets info on trade page, and more.
</Callout>

<Tabs>
  <Tab title="🟢 Prod">
      <Accordion title="v1.66.0 — Oct 30th" defaultOpen={true}>
      ...
      * "30D Return (APR)" was renamed to "APY" in the vaults list and vault page.
      ...
      <Accordion title="v1.66.0-rc.1 — Oct 24th" defaultOpen={false}>
  ...
  <Tab title="🟡 Testnet">
    ...
    No Testnet releases in this version.
