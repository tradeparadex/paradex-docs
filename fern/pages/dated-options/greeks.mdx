...
Greeks measure the sensitivity of an option's price to changes in underlying factors such as spot price, implied volatility, interest rates, and time. Paradex computes Greeks using the **Black-76 model** and provides both **Raw Greeks** and **Cash Greeks**.
