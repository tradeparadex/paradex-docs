...
Paradex maintains a fair estimate of market IV (mark IV) through a multi-source approach:

<CardGroup cols={2}>
  <Card title="Market Data Collection" icon="fa-solid fa-database">
    <p class="text-sm">Gathers best bid/ask prices and last trade price</p>
  </Card>
  <Card title="Mid Price Calculation" icon="fa-solid fa-calculator">
    <p class="text-sm">Determines the middle point between bid and ask</p>
  </Card>
  <Card title="External Calibration" icon="fa-solid fa-balance-scale">
    <p class="text-sm">Integrates IV data from Deribit dated options</p>
  </Card>
  <Card title="Fair Value Assessment" icon="fa-solid fa-check-circle">
    <p class="text-sm">Combines all inputs to establish a reliable Mark IV</p>
  </Card>
</CardGroup>
