...
import { TVLLimitDisplay } from '../../components/TVLLimitDisplay.jsx';
...
* <span style="color:#c83efb;">**Maximum Total Value Locked (TVL):**</span> <TVLLimitDisplay fallback="50 million USDC" /> across all users
