---
---
export const contractName = "COAI-USD-PERP";
export const productType = "COAI Perpetual Future";
export const settlementCurrency = "USDC";
export const baseCurrency = "COAI";
export const quoteCurrency = "USD";
export const fundingPeriod = "1.0 hours";
export const tickSize = "0.0001 USD";
export const orderSizeIncrement = "1 COAI";
export const minOrderValue = "10 USD";
export const maxOrderSize = "70,000 COAI";
export const maxOpenOrders = "75";
export const positionLimit = "220,000 COAI";
