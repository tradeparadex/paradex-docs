...
- **B.** [**Remote MCP Deployment**](#remote-mcp-deployment) — Market data only. Host your own MCP server on a cloud platform.
- **C.** [**Paradex-hosted MCP**](#paradex-hosted-mcp) — Market data only. No installation needed, just add a URL.
