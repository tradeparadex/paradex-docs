...
When deploying remotely, the server runs in HTTP mode. Set the `MCP_TRANSPORT` environment variable to `streamable-http` — all platform guides below include this.
