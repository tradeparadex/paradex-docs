...
3. Select our bridge provider to facilitate the transaction (ie: [Layerswap](https://layerswap.io/))
4. Continue your deposit offsite on the bridge provider website
   1. Source: Set up accordingly for source chain
...
3. Select bridge provider to facilitate the transaction (ie: [Layerswap](https://layerswap.io/))
4. Continue your withdrawal offsite on the bridge provider website
   ...
   2. Destination: Set up accordingly for destination chain
...
Direct transferring of funds from a Public Starknet Wallet to your Paradex Address is not supported and will result in a loss of funds.
</Warning>
