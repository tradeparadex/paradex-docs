...
<Callout intent="info">
  **🟢 Prod: April 8th–April 12th, 2025** — Bug fix for submitting orders with 100% leverage on order slider for Perpetual Options and reduced price bands.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.12-rc.1): April 12th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.11-rc.1): April 11th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.10-rc.1): April 11th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.9-rc.1): April 11th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.7-rc.1): April 10th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.5-rc.1): April 9th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.90.3-rc.1): April 8th** — Same changes, plus:
  * Markets Menu: do not display keyboard on dropdown open---
</Callout>
