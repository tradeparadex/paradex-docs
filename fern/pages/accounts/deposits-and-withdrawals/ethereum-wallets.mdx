...
<Note>
**Note:** Paradex has launched 1-step deposits and withdrawals as of 28 November 2024. 

Users can seamlessly transfer funds from their L1 to Paradex without needing the additional step of transferring between the Paradex bridge contract and Paradex. 

Likewise, a user's funds will automatically be transferred back to their wallet once they are available on the Paradex Bridge without the extra step of initiating the transfer from the Paradex Bridge to their L1.
</Note>
