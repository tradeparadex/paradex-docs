...
Recieve a <span style="color: #e78fff;">**12.5% commission**</span> on the XP earned by your referred users each week (note: must share at least 20% with referees - see "Referee Benefits" below).

<small>_Must refer at least $10k+ in volume to qualify. Self referrals will not be eligible for XP based commissions._</small>
...
| **Referral XP** | 12.5% commission on XP by referred users per the base Referral Program (TAP participants earn from both programs) |
...
To reward your referees for using your referral code, Referral Codes and Affiliates can select a <span style="color: #e78fff;">**points share rate between 20% (default minimum) and 100%.**</span> You can choose your rate on the affiliate dashboard that will be launched shortly. Currently the default share rate is 20%.
