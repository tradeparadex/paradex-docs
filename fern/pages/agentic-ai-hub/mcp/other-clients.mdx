...
This page covers Windsurf, Gemini CLI, and OpenAI Codex CLI. Each has two independent setup options — choose one:

- [**Local MCP Setup**](#local-mcp-setup) — Full API access including trading. Requires installing a few tools on your machine.
- [**Connect to Paradex MCP**](#connect-to-paradex-mcp) — Market data only. No installation needed.
