...
<Accordion title="How long after my deposit can I withdraw my funds?">
  ...
  Period](https://docs.paradex.trade/docs/trading/vaults/tutorials/vault-withdrawal#note-you-will-not-be-able-to-withdraw-from-the-vault-if-your-minimum-lockup-period-of-not-over-yet)
