...
Resources are read-only data sources that your AI assistant can access in the background. Unlike [tools](/agentic-ai-hub/mcp/tools) (which are called on demand), resources provide always-available context.
