...
<Callout intent="info">
  **🟢 Prod: Oct 13th–Oct 16th, 2025** — Fixed leverage slider calculation for Options when using Spot Notional order value.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.116.9-rc.1): Oct 16th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.116.3-rc.1): Oct 15th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.116.2-rc.1): Oct 14th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.116.1-rc.0): Oct 13th** — Same changes, same date.
</Callout>
...
<Callout intent="note">
  **🟡 Testnet (v1.116.0-rc.1): Oct 11th** — Same changes.
</Callout>
