---
title: Socialized Losses and Last Resort Mechanism
---
...
$$
\small\text{Socialized Loss Factor}
= \frac{\text{Exchange Bankruptcy Amount}}
{\text{Total Exchange USDC Balance} + \text{Exchange Bankruptcy Amount}}
$$
