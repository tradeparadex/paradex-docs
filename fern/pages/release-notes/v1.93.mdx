---
title: v1.93
description: "Add market symbol filter to markets_summary WebSocket subscription channel."
---

<Callout intent="info">
  **April 28th–May 2nd, 2025** — Add market symbol filter to markets_summary WebSocket subscription channel.
</Callout>
...
<Tabs>
  ...
  <Tab title="🟡 Testnet">
      <Accordion title="v1.93.9-rc.1 — May 2nd" defaultOpen={false}>
      ...
      * Add market symbol filter to `markets_summary` WebSocket subscription channel.
      ...
      <Accordion title="v1.93.7-rc.1 — April 30th" defaultOpen={false}>
      ...
      * Portfolio Risk: `Cash Greeks` feature and `Greeks` tab in user preferences.
      ...
      <Accordion title="v1.93.6-rc.1 — April 29th" defaultOpen={false}>
      ...
      * Added `90D`, `180D` filter for Portfolio Historical Chart.
      ...
      <Accordion title="v1.93.4-rc.1 — April 29th" defaultOpen={false}>
      ...
      * Strikes tab for Options can now be opened with via URL directly with query string `active_central_tab=strikes`
      ...
      <Accordion title="v1.93.3-rc.1 — April 29th" defaultOpen={false}>
      ...
      * Removed blur from modal background.
      ...
      <Accordion title="v1.93.1-rc.1 — April 28th" defaultOpen={false}>
      ...
      * Display `Spot Price Chart` for `Perp Options` and `Futures`.
      ...
      <Accordion title="v1.93.0-rc.1 — April 25th" defaultOpen={false}>
