...
Paradex offers the following margin modes to accommodate different trading strategies:

<CardGroup>
  <Card title="Cross Margin" icon="c" href="/trading/risk/cross-margin-requirement">
    Margin shared across all positions.
  </Card>
  <Card title="Isolated Margin" icon="i">
    Margin based on individual positions.
  </Card>
  <Card title="Portfolio Margin" icon="p" href="/trading/risk/portfolio-margin">
    Portfolio-level risk evaluation for reduced margin. Currently in beta.
  </Card>
</CardGroup>
...
| Component | Cross Margin | Isolated Margin | Portfolio Margin |
|-----------|--------------|-----------------|------------------|
| **Account Value** | Sum of<br/>• USD Collateral (USDC balance)<br/>• Unrealized PnL from all positions<br/>• Benefits from PnL offsetting across positions | Position Value only | Sum of<br/>• USD Collateral (USDC balance)<br/>• Unrealized PnL from all positions |
| **Margin Requirement** | Based on<br/>• All open positions<br/>• Exchange-level parameters<br/>• [Cross Margin Requirement](cross-margin-requirement) methodology | Based on<br/>• Individual position only<br/>• Exchange-level parameters | Based on<br/>• Portfolio-level risk evaluation<br/>• SCAN risk scenarios<br/>• [Portfolio Margin](portfolio-margin) methodology |
