...
2. **Post-Only Requirement**: All RPI orders must be [Post-Only](/trading/orders/order-instructions#post-only), meaning they will only provide liquidity and never take liquidity.
