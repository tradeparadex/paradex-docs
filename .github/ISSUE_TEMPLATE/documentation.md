...
description: "Report an issue or suggest improvements for Paradex docs"
body:
  - type: markdown
    attributes:
      value: "Help us improve our documentation by reporting an issue or suggesting an improvement."
  - type: input
    id: page-url
    attributes:
      label: "Documentation Page URL"
      description: "Provide the URL of the documentation page where you found the issue."
      placeholder: "e.g., https://docs.paradex.trade/your-page"
    validations:
      required: true
  - type: textarea
