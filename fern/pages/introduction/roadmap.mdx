  ...
  <Tab title="2026 & Beyond">
    ...
    <CardGroup cols={3}>
      <Card title="April 2026">
        **Liquidity & Trading**
          - Launched $DIME utility (fees, staking) and new fees structure
          - Order Size Slider for Portfolio Margin accounts


        **Products**
          - Launched Dated Options in Public Beta
          - Expanded TradFi listings to include Silver, Platinum, Oil, Gas and more
        ...
        **UX**
          ...
          - Smart Notifications with cross-tab sync
          - Options chain UX improvements
