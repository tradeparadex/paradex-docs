...
Native C++ and Rust offer the lowest latency for traders when signing their orders (0.4ms and 0.2ms avg latency). For more information you can visit our github [signing library](https://github.com/tradeparadex/starknet-signing-cpp/tree/a4978dbba8dfe2db42b38d07287fb0abf5f66627?tab=readme-ov-file) 

## Cancel By Order ID & Market

There is an **optional "market" parameter** for cancel by client order id which makes the call significantly faster. 
https://api.prod.paradex.trade/swagger/index.html#/Orders/orders-cancel-by-client-id
...
<Tip>
Reference: [Orders API Documentation](/api/prod/orders/batch)
</Tip>
...
<Tip>
Reference: [WebSocket API Documentation](/api/ws/general-information)
</Tip>
...
<Tip>
Reference: [Rate Limits Documentation](/api/general-information/rate-limits/api)
</Tip>
...
<Tip>
Reference: [WebSocket Rate Limits](/api/ws/general-information/rate-limits)
</Tip>
