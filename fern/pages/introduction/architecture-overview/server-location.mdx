...
The best way to synchronize your clock with our servers is via the Amazon Time Sync Service. Use the public Amazon Time Sync Service, which is accessible over the internet at `time.aws.com`.
