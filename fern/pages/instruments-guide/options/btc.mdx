...
- OTM Put Option with Strike = 40 and Option Mark Price = 25
  - IMR = min(short_otm_imf _ Spot Price, short_put_cap_imf _ Strike Price) = min(25, 20) = 20
  - MMR = min(short_otm_mmf _ Spot Price, short_put_cap_mmf _ Strike Price) = min(12.5, 20) = 12.5
