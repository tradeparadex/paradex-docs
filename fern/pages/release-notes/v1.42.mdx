---
title: v1.42
description: "USDC icon was added to the deposit and withdrawal modals. Added a read-only field with icon for \."Deposit from: Ethere..."
---

<Callout intent="info">
  **May 15th–May 9th, 2024** — USDC icon was added to the deposit and withdrawal modals. Added a read-only field with icon for "Deposit from: Ethere..
</Callout>
