...
- $\text{Net MMR}$: This is a fraction of the $\text{Net IMR}$ based on $\text{MMF Factor}$
    - Note that $\text{MMF Factor}$ is currently set to $50\%$ for all perpetual futures. This means that Net MMR is half of the Net IMR
- $\text{Fee Provision}$: This is a provision for the position exit fee, so this is equal to $\text{Taker Fee * Position Value}$

# Leverage

![Screenshot 2025-03-27 at 15.17.42.png](Cross%20Margin%20Requirement%201c332558084480dc8f53d6bb843279af/Screenshot_2025-03-27_at_15.17.42.png)
