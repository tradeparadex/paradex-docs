...
The maximum amount of USDC you can withdraw is determined by your [Free Collateral Balance](margin-term-reference#free-collateral-balance-usd), but is capped by your actual Account USDC Balance. In other words, you can withdraw up to your Free Collateral Balance in USDC, but never more than the total USDC you currently have in your account.

*Account USDC Balance* is equal to a user's net USDC deposits (deposits - withdrawals) plus realized PnL (including funding), minus paid fees.
