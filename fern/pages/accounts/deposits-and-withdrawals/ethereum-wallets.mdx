...
## <span class="prdx--text-purple">Deposits</span>
...
#### <span class="prdx--text-purple">**Step 1: Initiate a Deposit to the Paradex Bridge**</span>
...
2. Click the <span class="prdx--text-purple">**“Deposit”**</span> button and enter the amount of funds you wish to transfer to Paradex.
...
3. Confirm the transaction in MetaMask to send USDC to the Paradex bridge contract by selecting <span class="prdx--text-purple">**“Initiate Deposit to Bridge”.**</span>
...
## <span class="prdx--text-purple">Withdrawals</span>

Paradex has a **two step withdrawal** process which entails:

1. <span class="prdx--text-purple">**Transferring funds from Paradex to the Paradex bridge contract to**</span> (requires L2 blockchain signature).
2. <span class="prdx--text-purple">**Transferring funds from the Paradex bridge contract to your Ethereum wallet**</span> (requires L1 blockchain signature).

<img src="../../../assets/Paradex-withdraw-Flow.png" alt=""/>

#### <span class="prdx--text-purple">**Step 1: Initiate a Withdrawal to the Paradex Bridge**</span>

1. Navigate to the **“**[**Portfolio**](https://app.paradex.trade/portfolio)**”** tab in the webapp and connect your wallet (MetaMask or other supported wallet)
2. Click the <span class="prdx--text-purple">**“Withdraw”**</span> button and enter the amount of funds you wish to transfer from Paradex.
3. Click <span class="prdx--text-purple">**“Initiate Withdrawal to Bridge”**</span>.

#### <span class="prdx--text-purple">**Step 2: Transfer Funds from the Paradex Bridge to Wallet**</span>

4. Wait for L1 Confirmation:
   * Wait for the L1 withdrawal transaction to be confirmed on the Ethereum blockchain. Once confirmed, the deposit status will update to <span class="prdx--text-purple">**“Available - L1”**</span> in the “Deposit / Withdrawals” table.
...
5. Transfer to Wallet:
   * Click the <span class="prdx--text-purple">**“Withdraw to Wallet”**</span> button in the “Actions” section to complete the transfer of your funds from the bridge to your wallet. This may take a few minutes depending on Ethereum network conditions.
