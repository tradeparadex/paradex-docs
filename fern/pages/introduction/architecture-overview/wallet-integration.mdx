...
Paradex, a [Starknet Appchain](/overview/getting-started/architecture-overview/starknet-first-appchain), incorporates separate public/private keys from your connected wallet (ie: Ethereum L1). To interact with Paradex, here's a simplified overview:
