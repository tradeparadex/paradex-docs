...
<Steps>
    <Step title="Connect Wallet">
        ...
        <Frame>
        <div align="left">
        <img src="../../assets/trading/mobile_connect_wallet.png" alt="Enter URL and Connect Wallet" width="375"/>
        </div>
        </Frame>
    </Step>
    <Step title="Choose Wallet">
        <div align="left">
        <Frame>
        <img src="../../assets/trading/mobile_choose_wallet.png" alt="Click: Choose Wallet" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Tap Wallet">
        ...
        <img src="../../assets/trading/mobile_wallet_select.png" alt="" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Redirected to Wallet App">
        ...
        <img src="../../assets/trading/mobile_metamask_redirect.png" alt="" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Connect to Paradex">
        ...
        <img src="../../assets/trading/mobile_connect_paradex.png" alt="" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Generate Private Key">
        ...
        <div align="left">
        <Frame>
        <img src="../../assets/trading/mobile_generate_key.png" alt="Generate Private Key" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Sign Private Key">
        ...
        <div align="left">
        <Frame>
        <img src="../../assets/trading/mobile_sign_key.jpeg" alt="" width="375"/>
        </Frame>
        </div>
    </Step>
    <Step title="Start Trading">
        ...
        <div align="left">
        <Frame>
        <img src="../../assets/trading/mobile_start_trading.png" alt="Start Trading" width="375"/>
        </Frame>
        </div>
    </Step>
</Steps>
