...
We understand that, as an email wallet user, you might want to transfer funds from/to centralized exchanges. You can do that via our [cross-chain bridge](./cross-chain-bridging) partner Layerswap. 
