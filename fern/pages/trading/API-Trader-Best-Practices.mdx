---
title: Market Maker Guidelines
subtitle: Essential technical guidelines for market makers using the Paradex API to optimize trading performance, manage rate limits, and implement efficient liquidity provision strategies.
---
...
Contact Paradex support for rate limit increases based on trading volume and requirements.
