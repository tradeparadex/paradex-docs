...
- It is published on the [`funding_data` WebSocket channel](https://docs.paradex.trade/api/ws/web-socket-channels/funding-data-market-symbol) and embedded in every price tick.
