...
<Callout intent="info">
  **April 21st–April 25th, 2025** — Limit Position Close:, and more.
</Callout>

<Tabs>
  <Tab title="🟢 Prod">
      <Accordion title="v1.92.7 — April 25th" defaultOpen={true}>
      ...
      * Bug fix for base/quote currency conversion.
      ...
      <Accordion title="v1.92.5 — April 24th" defaultOpen={false}>
      ...
      * Slippage information configured would also be returned as part of GET `/account/profile` endpoint response.
      ...
      <Accordion title="v1.92.4 — April 23rd" defaultOpen={false}>
      ...
      * Order History: Updated column name from `Time(created at)` to `Updated at`. Order History table now sorted by `last updated` order.
      ...
      <Accordion title="v1.92.3 — April 22nd" defaultOpen={false}>
      ...
      * Removed `Leverage` tag for Perpetual Options `open` positions.
      ...
      <Accordion title="v1.92.1 — April 21st" defaultOpen={false}>
      ...
      * Portfolio Page & Trade Page: Added `Total PnL`, `Total Funding` to Positions/Derivatives tabs. These replace the `Realized PnL` and `Unrealized PnL` columns.
      ...
      <Accordion title="v1.92.0 — April 21st" defaultOpen={false}>
  ...
  <Tab title="🟡 Testnet">
      <Accordion title="v1.92.7-rc.1 — April 25th" defaultOpen={false}>
      ...
      * Bug fix for base/quote currency conversion.
      ...
      <Accordion title="v1.92.5-rc.1 — April 24th" defaultOpen={false}>
      ...
      * Slippage information configured would also be returned as part of GET `/account/profile` endpoint response.
      ...
      <Accordion title="v1.92.4-rc.1 — April 23rd" defaultOpen={false}>
      ...
      * Order History: Updated column name from `Time(created at)` to `Updated at`. Order History table now sorted by `last updated` order.
      ...
      <Accordion title="v1.92.2-rc.1 — April 22nd" defaultOpen={false}>
      ...
      * Removed `Leverage` tag for Perpetual Options `open` positions.
      ...
      <Accordion title="v1.92.1-rc.1 — April 21st" defaultOpen={false}>
      ...
      * Portfolio Page & Trade Page: Added `Total PnL`, `Total Funding` to Positions/Derivatives tabs. These replace the `Realized PnL` and `Unrealized PnL` columns.
      ...
      <Accordion title="v1.92.0-rc.1 — April 18th" defaultOpen={false}>
