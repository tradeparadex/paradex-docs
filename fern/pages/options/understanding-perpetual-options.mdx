...
<Tip title="Mark IV Calculation Flow" icon="chart-network">
  <div className="flex flex-col space-y-2">
    <div className="bg-blue-50 p-3 rounded-md border border-blue-100">Market Data → Best bid/ask + Last trade + Mid price</div>
    <div className="text-center">↓</div>
    <div className="bg-blue-50 p-3 rounded-md border border-blue-100">External Input → Deribit dated options IV calibration</div>
    <div className="text-center">↓</div>
    <div className="bg-green-50 p-3 rounded-md border border-green-100">Final Mark IV → Fair estimate even during illiquid periods</div>
  </div>
</Tip>
