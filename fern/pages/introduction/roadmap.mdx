...
<Tabs>
  <Tab title="Upcoming">
    <CardGroup cols={1}>
      ### Coming Soon: Jan - Jul 2025
      <Card title="Expand Product Offering" icon="fa-solid fa-circle-1" >
      ...
      <Card title="User Experience & Privacy" icon="fa-solid fa-circle-2" >
        * Social logins with Privy <Icon icon="check" color="#22C55E" /> 
        * Multi-strategy vaults (e.g., Covered Call Vaults)
      </Card>

      <Card title="Paradex Chain" icon="fa-solid fa-circle-3" >
        * Launching Paradex Chain & opening it to external developers
        * zk-based position privacy (via client side proving)
      </Card>

      <Card title="Full Decentralization" icon="fa-solid fa-circle-4" >
      ...
      <Card title="Infrastructure: Bridging & Oracles" icon="fa-solid fa-circle-5" >
  ...
  <Tab title="2025 (To Date)">
    <CardGroup cols={1}>
      <Card title="March 2025">
        ...
        * Opened up Top 300 Retail Traders on Paradex to Perpetual Options
      </Card>
      ...
      <Card title="January 2025">
        ...
        * Latency improvements (handle 5x throughput while maintaining P99)
        * Revamped Affiliate Program  
        * Opened up Shizopunk holders to Perpetual Options
      </Card>
    </CardGroup>
  </Tab>
  <Tab title="2024">
