...
Passing `sbe_enabled=True` appends the schema parameters to the connection URL. Omitting it is not supported for public channels; as of 21 September 2026 SBE is required.
